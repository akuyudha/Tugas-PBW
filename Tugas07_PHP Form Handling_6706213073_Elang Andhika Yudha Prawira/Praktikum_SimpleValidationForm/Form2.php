...
<html>
    ...
    <body>  
        ...
        <?php
            // mendefinisikan variabel kosong
            $nameErr = $emailErr = $genderErr = $websiteErr = "";
            $name = $email = $gender = $comment = $website = "";

            if ($_SERVER["REQUEST_METHOD"] == "POST") {
            if (empty($_POST["name"])) {
                $nameErr = "Name dibutuhkan";
            } else {
                $name = test_input($_POST["name"]);
                // periksa apakah nama hanya berisi huruf dan spasi
                if (!preg_match("/^[a-zA-Z \-\.\']*$/",$name)) {
                $nameErr = "Hanya berisi huruf dengan spasi, [.], dan [-].<br>";
                }
            }
            ...
            if (empty($_POST["website"])) {
                ...
                // jika sintaks URL address valid
            ...
            if (empty($_POST["gender"])) {
                $genderErr = "Dibutuhkan jenis kelamin";
            } else {
